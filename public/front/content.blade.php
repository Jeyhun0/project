    ...
    <div class="content-container">
        ...
        <div class="categories">
            ...
            <div class="categories_btns">
                <a href="{{route('/')}}"><button id="AllBTN" class="selected_category categories_left">All</button></a>
                @foreach($categories as $category)
                    <a href="{{route($category->category_name)}}"><button style="margin-left: 10px;">{{$category->category_name}}</button></a>
                @endforeach
            </div>
        </div>
