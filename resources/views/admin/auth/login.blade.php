...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('argon-dasboard/assets/img/apple-icon.png')}}">
    <link rel="icon" type="image/png" href="{{asset('argon-dasboard/assets/img/favicon.png')}}">
    <title>
    ...
    <!-- Font Awesome Icons -->
    <script src="{{asset('argon-dashboard/https://kit.fontawesome.com/42d5adcbca.js')}}" crossorigin="anonymous"></script>
    <link href="{{asset('argon-dashboard/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
    <!-- CSS Files -->
...
<!-- Github buttons -->
<script async defer src="{{asset('argon-dashboard/https://buttons.github.io/buttons.js')}}"></script>
